...
function Dashboard() {
  ...
  const StatCard = ({ icon: Icon, label, value, color }) => (
    <div className="bg-white rounded-lg shadow p-4 sm:p-6 border-l-4" style={{ borderColor: color }}>
      <div className="flex items-center justify-between gap-4">
        ...
        <Icon className="w-8 h-8 sm:w-12 sm:h-12 flex-shrink-0" style={{ color }} />
      </div>
    </div>
  );
  ...
  return (
    <div className="space-y-6 sm:space-y-8 px-4 sm:px-0">
      <div>
        ...
        <p className="text-sm sm:text-base text-gray-600 mt-2">Welcome to the Attendance Tracking System</p>
      </div>
      ...
      <div className="bg-white rounded-lg shadow p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          ...
          >
            ...
            <p className="text-xs sm:text-sm text-gray-600 mt-1">Add, edit, or view student records</p>
          </a>
          <a
            href="/classes"
          ...
          >
            ...
            <h3 className="font-semibold text-sm sm:text-base text-gray-900">Manage Classes</h3>
            <p className="text-xs sm:text-sm text-gray-600 mt-1">Create and organize classes</p>
          </a>
          <a
            href="/attendance"
          ...
          >
            ...
            <h3 className="font-semibold text-sm sm:text-base text-gray-900">Mark Attendance</h3>
